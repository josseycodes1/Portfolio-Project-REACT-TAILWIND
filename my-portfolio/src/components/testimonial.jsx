 ...
 export default function Testimonial() {
   return (
    ...
    <div>
     ...
     <div className="flex bg-blue-900 m-20 ssm:flex-col lg:flex-row ">
          ...
          p-8 hover:animate-pulse">
            <div className="overflow-hidden relative max-w-md mx-auto
                ...
                flex items-center gap-6 dark:bg-slate-800 dark:highlight-white/5">
                    <img src={t1} alt="" className="absolute -left-6 w-28
                    h-28 rounded-full shadow-lg"/>
              ...
              <div className="min-w-0 py-5 pl-28 pr-5">
                ...
                leading-tight truncate dark:text-slate-400">
                  ...
                  adipiscing elit <br /> aliqua. Lorem ipsum dolor <br /> sit amet, consectetur <br /> 
       ...
       <div className="relative rounded-xl overflow-auto 
          p-8 hover:animate-pulse">
            <div className="overflow-hidden relative max-w-md mx-auto
                bg-white shadow-lg ring-1 ring-black/5 rounded-xl
                flex items-center gap-6 dark:bg-slate-800 dark:highlight-white/5">
                    <img src={t2} alt="" className="absolute -left-6 w-28
                    h-28 rounded-full shadow-lg"/>
       ...
       <div className="relative rounded-xl overflow-auto 
          p-8 hover:animate-pulse">
            <div className="overflow-hidden relative max-w-md mx-auto
                bg-white shadow-lg ring-1 ring-black/5 rounded-xl
                flex items-center gap-6 dark:bg-slate-800 dark:highlight-white/5">
                    <img src={t3} alt="" className="absolute -left-6 w-28
                    h-28 rounded-full shadow-lg"/>
       ...
       <div className="relative rounded-xl overflow-auto 
          p-8 hover:animate-pulse">
            <div className="overflow-hidden relative max-w-md mx-auto
                bg-white shadow-lg ring-1 ring-black/5 rounded-xl
                flex items-center gap-6 dark:bg-slate-800 dark:highlight-white/5">
                    <img src={t4} alt="" className="absolute -left-6 w-28
                    h-28 rounded-full shadow-lg"/>
